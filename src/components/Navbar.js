...
function Navbar() {
    ...
    return (
        <header className=" bg-green-600 z-10 top-0 sticky">
                ...
                <div className="flex items-center justify-between h-16">
                    <div className="flex-1 md:flex md:items-center md:gap-12">
                        ...
                        >
                            ...
                            <h1 className="text-3xl font-sans">ERedux</h1>
                        </Link>
                    </div>
                    ...
                    <div className={"flex items-center md:gap-8 "}>
                        ...
                        <div className="flex items-center gap-2">
                            <div className="sm:gap-4 sm:flex">
                                <a
                                    className="px-5 py-2.5 text-sm font-medium text-white bg-teal-800 rounded-md shadow cursor-pointer"
